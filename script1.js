...
function updateCountdown() {
    ...
    // Update "Offer Ends in" timer (total time remaining in minutes)
    ...
    document.querySelectorAll('.offer-timer').forEach(el => {
        if (displayHours > 0) {
            el.textContent = `Offer Ends in ${displayHours}:${formatNumber(displayMinutes)} Hrs`;
        } else {
            el.textContent = `Offer Ends in ${displayMinutes} Mins`;
        }
    });
}
        ...
        <div id="registrationPopup" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" style="display: none;">
            <div class="bg-white rounded-2xl max-w-md w-full p-6 relative shadow-2xl animate-slideUp">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-sm text-gray-600 offer-timer font-montserrat">Offer Ends Soon</p>
                </div>
